...
class Bot():
    ...
    def say_hello(self):
        # Say hello to owner!
        self.msg(self.owner, 'Hola Owner :) Pon !help Para Ver Mis Comandos!.')
...
it sends him a private message showing text.'''
  ...
  !reconnect new_config -- reconnects using new_cofig configuration.'''
            ...
            if r is not None:
                print "help: ", r
                help_str = '''Mi codigo esta en https://github.com/JoseACS/Kecv - lista de comandos:
...
.
Con <<!help comando>> para una ayuda de comandos específicos..''' % self.nick
                self.long_msg(channel_to, help_str)
                return
